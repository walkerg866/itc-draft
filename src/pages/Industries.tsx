...
const industries = [
  {
    ...
    image: automotiveImg,
    description:
      "Our automotive tubing products are available as coiled, cut to length, and as fabricated assemblies. ITC tubing delivers exceptional value and performance for brake lines, fuel lines, transmission cooler lines, and more.",
    applications: [
      "Brake lines",
      "Fuel lines",
  ...
  },
  {
    ...
    image: oilGasImg,
    description:
      "Indiana Tube Corporation tubing is manufactured to meet rigorous industry standards and the most demanding customer applications in the energy sector. From downhole to surface, ITC delivers.",
    applications: [
      "Control lines",
      "Injection tubing",
      "Capillary tubing",
  ...
  },
  {
    ...
    image: hvacImg,
    description:
      "ITC produces clean, high-quality tubing compatible with R134a and modern refrigerants, suitable for fabrication in the appliance and heating element industries.",
    applications: [
      "Refrigeration lines",
      "Heating elements",
      "Condenser tubing",
  ...
  },
  {
    ...
    image: heavyEquipImg,
    description:
      "ITC tubing is manufactured to meet the most demanding hydraulic and high-pressure applications. We are your complete source for high-quality, single wall, induction welded, low carbon steel tubing.",
    applications: [
      "Hydraulic lines",
  ...
  },
  {
    ...
    image: structuralImg,
    description:
      "ITC produces high-quality tubing suitable for fabrication in lawn and garden, structural, furniture, and general fabrication industries. All tubing is high-frequency welded with modern welding technology.",
    applications: [
          ...
          <SectionReveal>
            <div className="max-w-2xl">
              ...
              <p className="text-steel-muted text-lg leading-relaxed">
                For over 45 years, Indiana Tube has specialized as a solution
                provider for standard and custom tubing across the world's most
        ...
        <div className="container text-center">
          <SectionReveal>
            ...
            <p className="text-muted-foreground text-lg max-w-xl mx-auto mb-8">
              Our custom tubing capabilities extend far beyond these core
              sectors. Let's talk about your specific needs.
            </p>
            <Link
              to="/contact"
